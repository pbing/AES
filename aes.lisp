...
(defun mix-columns (n)
  (declare (type (unsigned-byte 128) n))
  (let ((b00 (logxor (g* 2 (ldb (byte 8 120) n)) (g* 3 (ldb (byte 8 112) n)) (g* 1 (ldb (byte 8 104) n)) (g* 1 (ldb (byte 8 96) n))))
	(b10 (logxor (g* 1 (ldb (byte 8 120) n)) (g* 2 (ldb (byte 8 112) n)) (g* 3 (ldb (byte 8 104) n)) (g* 1 (ldb (byte 8 96) n))))
	(b20 (logxor (g* 1 (ldb (byte 8 120) n)) (g* 1 (ldb (byte 8 112) n)) (g* 2 (ldb (byte 8 104) n)) (g* 3 (ldb (byte 8 96) n))))
	(b30 (logxor (g* 3 (ldb (byte 8 120) n)) (g* 1 (ldb (byte 8 112) n)) (g* 1 (ldb (byte 8 104) n)) (g* 2 (ldb (byte 8 96) n))))

	(b01 (logxor (g* 2 (ldb (byte 8  88) n)) (g* 3 (ldb (byte 8  80) n)) (g* 1 (ldb (byte 8  72) n)) (g* 1 (ldb (byte 8 64) n))))
	(b11 (logxor (g* 1 (ldb (byte 8  88) n)) (g* 2 (ldb (byte 8  80) n)) (g* 3 (ldb (byte 8  72) n)) (g* 1 (ldb (byte 8 64) n))))
	(b21 (logxor (g* 1 (ldb (byte 8  88) n)) (g* 1 (ldb (byte 8  80) n)) (g* 2 (ldb (byte 8  72) n)) (g* 3 (ldb (byte 8 64) n))))
	(b31 (logxor (g* 3 (ldb (byte 8  88) n)) (g* 1 (ldb (byte 8  80) n)) (g* 1 (ldb (byte 8  72) n)) (g* 2 (ldb (byte 8 64) n))))

	(b02 (logxor (g* 2 (ldb (byte 8  56) n)) (g* 3 (ldb (byte 8  48) n)) (g* 1 (ldb (byte 8  40) n)) (g* 1 (ldb (byte 8 32) n))))
	(b12 (logxor (g* 1 (ldb (byte 8  56) n)) (g* 2 (ldb (byte 8  48) n)) (g* 3 (ldb (byte 8  40) n)) (g* 1 (ldb (byte 8 32) n))))
	(b22 (logxor (g* 1 (ldb (byte 8  56) n)) (g* 1 (ldb (byte 8  48) n)) (g* 2 (ldb (byte 8  40) n)) (g* 3 (ldb (byte 8 32) n))))
	(b32 (logxor (g* 3 (ldb (byte 8  56) n)) (g* 1 (ldb (byte 8  48) n)) (g* 1 (ldb (byte 8  40) n)) (g* 2 (ldb (byte 8 32) n))))

	(b03 (logxor (g* 2 (ldb (byte 8  24) n)) (g* 3 (ldb (byte 8  16) n)) (g* 1 (ldb (byte 8   8) n)) (g* 1 (ldb (byte 8  0) n))))
	(b13 (logxor (g* 1 (ldb (byte 8  24) n)) (g* 2 (ldb (byte 8  16) n)) (g* 3 (ldb (byte 8   8) n)) (g* 1 (ldb (byte 8  0) n))))
	(b23 (logxor (g* 1 (ldb (byte 8  24) n)) (g* 1 (ldb (byte 8  16) n)) (g* 2 (ldb (byte 8   8) n)) (g* 3 (ldb (byte 8  0) n))))
...
(defun inv-mix-columns (n)
  (declare (type (unsigned-byte 128) n))
  (let ((b00 (logxor (g* 14 (ldb (byte 8 120) n)) (g* 11 (ldb (byte 8 112) n)) (g* 13 (ldb (byte 8 104) n)) (g*  9 (ldb (byte 8 96) n))))
	(b10 (logxor (g*  9 (ldb (byte 8 120) n)) (g* 14 (ldb (byte 8 112) n)) (g* 11 (ldb (byte 8 104) n)) (g* 13 (ldb (byte 8 96) n))))
	(b20 (logxor (g* 13 (ldb (byte 8 120) n)) (g*  9 (ldb (byte 8 112) n)) (g* 14 (ldb (byte 8 104) n)) (g* 11 (ldb (byte 8 96) n))))
	(b30 (logxor (g* 11 (ldb (byte 8 120) n)) (g* 13 (ldb (byte 8 112) n)) (g*  9 (ldb (byte 8 104) n)) (g* 14 (ldb (byte 8 96) n))))

	(b01 (logxor (g* 14 (ldb (byte 8  88) n)) (g* 11 (ldb (byte 8  80) n)) (g* 13 (ldb (byte 8  72) n)) (g*  9 (ldb (byte 8 64) n))))
	(b11 (logxor (g*  9 (ldb (byte 8  88) n)) (g* 14 (ldb (byte 8  80) n)) (g* 11 (ldb (byte 8  72) n)) (g* 13 (ldb (byte 8 64) n))))
	(b21 (logxor (g* 13 (ldb (byte 8  88) n)) (g*  9 (ldb (byte 8  80) n)) (g* 14 (ldb (byte 8  72) n)) (g* 11 (ldb (byte 8 64) n))))
	(b31 (logxor (g* 11 (ldb (byte 8  88) n)) (g* 13 (ldb (byte 8  80) n)) (g*  9 (ldb (byte 8  72) n)) (g* 14 (ldb (byte 8 64) n))))

	(b02 (logxor (g* 14 (ldb (byte 8  56) n)) (g* 11 (ldb (byte 8  48) n)) (g* 13 (ldb (byte 8  40) n)) (g*  9 (ldb (byte 8 32) n))))
	(b12 (logxor (g*  9 (ldb (byte 8  56) n)) (g* 14 (ldb (byte 8  48) n)) (g* 11 (ldb (byte 8  40) n)) (g* 13 (ldb (byte 8 32) n))))
	(b22 (logxor (g* 13 (ldb (byte 8  56) n)) (g*  9 (ldb (byte 8  48) n)) (g* 14 (ldb (byte 8  40) n)) (g* 11 (ldb (byte 8 32) n))))
	(b32 (logxor (g* 11 (ldb (byte 8  56) n)) (g* 13 (ldb (byte 8  48) n)) (g*  9 (ldb (byte 8  40) n)) (g* 14 (ldb (byte 8 32) n))))

	(b03 (logxor (g* 14 (ldb (byte 8  24) n)) (g* 11 (ldb (byte 8  16) n)) (g* 13 (ldb (byte 8   8) n)) (g*  9 (ldb (byte 8  0) n))))
	(b13 (logxor (g*  9 (ldb (byte 8  24) n)) (g* 14 (ldb (byte 8  16) n)) (g* 11 (ldb (byte 8   8) n)) (g* 13 (ldb (byte 8  0) n))))
	(b23 (logxor (g* 13 (ldb (byte 8  24) n)) (g*  9 (ldb (byte 8  16) n)) (g* 14 (ldb (byte 8   8) n)) (g* 11 (ldb (byte 8  0) n))))
